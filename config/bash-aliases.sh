...
alias gdw,,='git diff --word-diff=color | less -R'
 alias gdwc='git diff --word-diff=color --cached'
...
alias gdom,='git diff origin/master | less -R -S'
 ...
 alias gfop='git fetch origin --prune'
  ...
  alias gl,='git log --decorate | less -R -S'
...
alias glodga,='git log --oneline --decorate --graph --all | less -R -S'
 alias glos='git log --oneline --stat --decorate'
alias glos,='git log --oneline --stat --decorate | less -R -S'
...
alias glpr,='git log -p --reverse master.. | less -R -S'
 alias glpw='git log -p --decorate --word-diff=color'
alias glpw,='git log -p --decorate --word-diff=color | less -R -S'
