...
# bash aliases for more efficient git use:
 ...
 alias gdm,='git diff master | less -r'
 alias gdom='git diff origin/master'
   alias gl='git log | less -r'
  alias glo='git log --oneline'
 alias glod='git log --oneline --decorate | less -r'
 alias glog='git log --oneline --graph | less -r'
alias glodg='git log --oneline --decorate --graph | less -r'
alias glo-m='git log --oneline master..'
alias glo-om='git log --oneline origin/master..'
  alias glp='git log -p | less -r'
